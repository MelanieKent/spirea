...
export const About = () => {
  return (
    <>
      <div
        className="min-h-[90vh] w-screen pt-0 flex flex-col items-center justify-center text-xl p-4"
        style={{
      ...
      <div
        className="min-h-[50vh] w-screen pt-0 text-xl flex flex-col items-center justify-center gap-32 p-4"
        style={{
      ...
      >
        <div className="flex flex-col gap-6 max-w-[60rem] mt-16 sm:mt-0">
