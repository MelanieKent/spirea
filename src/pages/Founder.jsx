export const Founder = () => {
  return (
    <div
      className="h-screen w-screen pt-0 flex flex-col items-center justify-center text-xl gap-48"
      style={{
    ...
    >
      <div className="grid grid-cols-[2fr_1fr] max-w-[80rem] text-left">
        ...
        <div className="flex items-center justify-center">
          <img className="w-64" src={`${process.env.PUBLIC_URL}/headshot.png`} />
        </div>
      </div>
